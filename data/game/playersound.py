...
class PlayerSound:
    def __init__(self, channel=0):
        ...
        self.player = pygame.mixer.Channel(channel)
    ...
    def load_sound(self, path):
        ...
        self.player.play(sound)  # set media to player
    ...
    def play(self):
        sound = load_music(self.playlist_files[self.track])
